          ...
          <div class="konten">
            ...
            <div class="row">           
                <?php
                  ...
                  $query = mysqli_query($koneksi, "SELECT * FROM ipm ORDER BY id_ipm DESC LIMIT $start, $perPage");
                    while ($result = mysqli_fetch_assoc($query)) {

              ?>
            <div class="col-sm-12 col-md-6">
                <div class="card">
                    <img src="asset/img/ipm/<?= $result['foto'] ?>" height="260">
                    <div class="card-body">
                      <h5><?= substr($result['judul'], 0, 25). "..." ?></h5>
                      <p class="card-title"><?= substr($result['deskripsi'], 0, 33). "..." ?></p>
                  </div>
                      <p><a href="detail-ipm.php?id=<?= $result['id_ipm']; ?>" class="btn btn-primary ml-2">Baca selengkapnya</a></p>
                </div>
            </div>  
            <?php  } ?>
          </div><br>
