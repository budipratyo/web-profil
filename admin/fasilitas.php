...
<html lang="en">
  ...
  <body>
    ...
    <div class="row no-gutters mt-5">
      ...
      <div class="cold-md-9 p-5 pt-2">
        <h3>
          <i class="far fa-building mr-2"></i>Fasilitas
        </h3><hr>

        <a href="tambah/tambah-fasilitas.php" class="btn btn-primary"><i class="fas fa-plus mr-2"></i>Tambah fasilitas</a>
      ...
      ?>
          <tbody class="text-center">
            <tr>
              <th scope="row"><?= $no++ ?></th>
              <td><img src="../asset/img/fasilitas/<?= $result['foto'] ?>" width="100"></td>
              <td><?= $result['deskripsi'] ?></td>
              <td>
                <a href="edit/edit-fasilitas.php?id=<?= $result['id_fasilitas']; ?>" class="btn btn-success">Edit</a>
              </td>
              <td>
                <a href="hapus/hapus-fasilitas.php?id=<?= $result['id_fasilitas']; ?>" class="btn btn-danger">Hapus</a>
              </td>
            </tr>
          </tbody>
      <?php  } ?>
