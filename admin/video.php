...
<html lang="en">
  ...
  <body>
    ...
    <div class="row no-gutters mt-5">
      ...
      <h3><i class="fas fa-tv mr-2"></i>video</h3>
      <hr>
      
      <a href="tambah/tambah-video.php" class="btn btn-primary"><i class="fas fa-plus mr-2"></i>Tambah Video</a>
      ...
      ?>
          <tbody class="text-center">
            <tr>
              ...
              <td><?= $result['link'] ?></td>
              <td>
                <a href="edit/edit-video.php?id=<?= $result['id_video']; ?>" class="btn btn-success">Edit</a>
              </td>
              <td>
                <a href="hapus/hapus-video.php?id=<?= $result['id_video']; ?>" class="btn btn-danger">Hapus</a>
              </td>
            </tr>
          </tbody>
      <?php  } ?>
