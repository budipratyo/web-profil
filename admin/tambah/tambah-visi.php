...
<html lang="en">
  ...
  <body>
    ...
    <div class="row no-gutters mt-5">
      ...
      <h3><i class="fas fa-bullseye mr-2"></i>Tambah Visi</h3>
      <hr>
      ...
      <form method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input type="text" name="visi" class="form-control" id="exampleFormControlInput1" placeholder="Tulis Visi">
            </div>
          ...
          if (isset($_POST['submit'])) {
            ...
            $visi = $_POST['visi'];
             ...
             $query = "INSERT INTO visi(visi) VALUES ('$visi')";
             $result = mysqli_query($koneksi, $query);

             if (!$result) {
               echo "<script>
                   alert('gagal menambah visi');
                   window.location.assign('tambah-visi.php');
               </script>";
             } else {
               echo "<script>
                   alert('berhasil menambahkan visi');
