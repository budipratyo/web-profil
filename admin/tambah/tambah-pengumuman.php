...
<html lang="en">
  ...
  <body>
    ...
    <div class="row no-gutters mt-5">
      ...
      <h3><i class="fas fa-bullhorn mr-2"></i>Tambah Pengumuman</h3>
      <hr>

      <form method="post" enctype="multipart/form-data">
            <div class="form-group">
              <label for="exampleFormControlInput1">Judul Pengumuman</label>
              <input type="text" name="judul_pengumuman" class="form-control" id="exampleFormControlInput1">
            </div>
            <div class="form-group">
          ...
          if (isset($_POST['submit'])) {
            ...
            $query = "INSERT INTO pengumuman(tanggal, judul_pengumuman, deskripsi) VALUES ('$tanggal', '$judul_pengumuman', '$deskripsi')";
            $result = mysqli_query($koneksi, $query);

            if (!$result) {
              echo "<script>
                  alert('gagal menambah pengumuman');
                  window.location.assign('tambah-pengumuman.php');
              </script>";
            } else {
              echo "<script>
