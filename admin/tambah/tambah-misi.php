...
<html lang="en">
  ...
  <body>
    ...
    <div class="row no-gutters mt-5">
      ...
      <h3><i class="fas fa-bullseye mr-2"></i>Tambah Misi</h3>
      <hr>
      ...
      <form method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input type="text" name="misi" class="form-control" id="exampleFormControlInput1" placeholder="Tulis misi">
            </div>
          ...
          if (isset($_POST['submit'])) {
            ...
            $misi = $_POST['misi'];
             ...
             $query = "INSERT INTO misi(misi) VALUES ('$misi')";
             $result = mysqli_query($koneksi, $query);

             if (!$result) {
               echo "<script>
                   alert('gagal menambah misi');
                   window.location.assign('tambah-misi.php');
               </script>";
             } else {
               echo "<script>
                   alert('berhasil menambahkan misi');
