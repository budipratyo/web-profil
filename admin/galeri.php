  ...
  <body>
    ...
    <div class="row no-gutters mt-5">
      ...
      <div class="cold-md-9 p-5 pt-2">
        <h3>
          <i class="fas fa-photo-video mr-2"></i>GALERI
        </h3><hr>

        <a href="tambah/tambah-galeri.php" class="btn btn-primary"><i class="fas fa-plus mr-2"></i>Tambah galeri</a>
      ...
      ?>
          <tbody class="text-center">
            <tr>
              <th scope="row"><?= $no++ ?></th>
              <td><img src="../asset/img/galeri/<?= $result['foto'] ?>" width="100"></td>
              <td><?= $result['deskripsi'] ?></td>
              <td>
                <a href="edit/edit-galeri.php?id=<?= $result['id_galeri']; ?>" class="btn btn-success">Edit</a>
              </td>
              <td>
                <a href="hapus/hapus-galeri.php?id=<?= $result['id_galeri']; ?>" class="btn btn-danger">Hapus</a>
              </td>
            </tr>
          </tbody>
      <?php  } ?>
