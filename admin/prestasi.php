...
<html lang="en">
  ...
  <body>
    ...
    <div class="row no-gutters mt-5">
      ...
      <h3><i class="fas fa-trophy mr-2"></i>PRESTASI</h3>
      <hr>
      
      <a href="tambah/tambah-prestasi.php" class="btn btn-primary"><i class="fas fa-plus mr-2"></i>Tambah Prestasi</a>
      ...
      ?>
          <tbody class="text-center">
            <tr>
              <th scope="row"><?= $no++ ?></th>
              <td><img src="../asset/img/prestasi/<?= $result['foto'] ?>" width="100"></td>
              <td><?= $result['judul'] ?></td>
              <td><?= $result['deskripsi'] ?></td>
              <td>
                <a href="edit/edit-prestasi.php?id=<?= $result['id_prestasi']; ?>" class="btn btn-success">Edit</a>
              </td>
              <td>
                <a href="hapus/hapus-prestasi.php?id=<?= $result['id_prestasi']; ?>" class="btn btn-danger">Hapus</a>
              </td>
            </tr>
          </tbody>
      <?php  } ?>
