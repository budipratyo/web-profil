...
<html lang="en">
  ...
  <body>
    ...
    <div class="row no-gutters mt-5">
      ...
      <h3><i class="far fa-building mr-2"></i>Edit Fasilitas</h3>
      <hr>

      <form method="post" enctype="multipart/form-data">
          <div class="form-group">
              <img src="../../asset/img/fasilitas/<?= $result['foto'] ?>" width="100"> <br>
    ...
    <?php   
          ...
          if (isset($_POST['submit'])) {
            ...
            if (!$foto) {
              ...
              $query = "UPDATE fasilitas SET foto ='$foto', deskripsi ='$deskripsi' WHERE id_fasilitas='$id' ";
              $result = mysqli_query($koneksi, $query);

              if (!$result) {
                echo "<script>
                    alert('gagal mengubah fasilitas');
                    window.location.assign('edit-fasilitas.php');
                </script>";
              } else {
                echo "<script>
