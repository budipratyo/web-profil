...
<html lang="en">
  ...
  <body>
    ...
    <div class="row no-gutters mt-5">
      ...
      <h3><i class="fas fa-photo-video mr-2"></i>EDIT GALERI</h3>
      <hr>

      <form method="post" enctype="multipart/form-data">
          <div class="form-group">
              <img src="../../asset/img/galeri/<?= $result['foto'] ?>" width="100"> <br>
            ...
            <button class="btn btn-warning"><a href="../galeri.php" class="text-white" style="text-decoration: none;">Kembali</a></button>
    ...
    <?php   
          ...
          if (isset($_POST['submit'])) {
            ...
            $dir = '../../asset/img/galeri/'. $foto;

            if (!$foto) {
              

              $query = "UPDATE galeri SET deskripsi ='$deskripsi' WHERE id_galeri='$id' ";
              $result = mysqli_query($koneksi, $query);

              if (!$result) {
                echo "<script>
                    alert('gagal mengubah galeri');
                    window.location.assign('edit-galeri.php');
                </script>";
              } else {
                echo "<script>
                    alert('berhasil mengubah galeri');
              ...
              $query = "UPDATE galeri SET foto ='$foto' deskripsi ='$deskripsi' WHERE id_galeri='$id' ";
              $result = mysqli_query($koneksi, $query);
