...
<html lang="en">
  ...
  <body>
    ...
    <div class="row no-gutters mt-5">
      ...
      <h3><i class="fas fa-tv mr-2"></i>EDIT PRESTASI</h3>
      <hr>

      <form method="post" enctype="multipart/form-data">
          <div class="form-group">
              <img src="../../asset/img/prestasi/<?= $result['foto'] ?>" width="100"> <br>
              <label for="exampleFormControlFile1">Pilih Foto</label>
              <input type="file" name="foto" class="form-control-file" id="exampleFormControlFile1">
            </div>
            <div class="form-group">
              <label for="exampleFormControlInput1">Prestasi Yang Di Raih</label>
            ...
            <button class="btn btn-warning"><a href="../prestasi.php" class="text-white" style="text-decoration: none;">Kembali</a></button>
    ...
    <?php   
          ...
          if (isset($_POST['submit'])) {
            ...
            $dir = '../../asset/img/prestasi/'. $foto;

            if (!$foto) {
              

              $query = "UPDATE prestasi SET judul ='$judul', deskripsi ='$deskripsi' WHERE id_prestasi='$id' ";
              $result = mysqli_query($koneksi, $query);

              if (!$result) {
                echo "<script>
                    alert('gagal mengubah prestasi');
                    window.location.assign('edit-prestasi.php');
                </script>";
              } else {
                echo "<script>
                    alert('berhasil mengubah prestasi');
              ...
              $query = "UPDATE prestasi SET foto ='$foto', judul ='$judul', deskripsi ='$deskripsi' WHERE id_prestasi='$id' ";
              $result = mysqli_query($koneksi, $query);
