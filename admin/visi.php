...
<html lang="en">
  ...
  <body>
    ...
    <div class="row no-gutters mt-5">
      ...
      <h3><i class="fas fa-tv mr-2"></i>VISI DAN MISI</h3>
      <hr>
      
      <a href="tambah/tambah-visi.php" class="btn btn-primary">Tambah Visi</a>
      ...
      ?>
          <tbody class="text-center">
            <tr>
              ...
              <td><?= $result['visi'] ?></td>
              <td>
                <a href="edit/edit-visi.php?id=<?= $result['id_visi']; ?>" class="btn btn-success">Edit</a>
              </td>
              <td>
                <a href="hapus/hapus-visi.php?id=<?= $result['id_visi']; ?>" class="btn btn-danger">Hapus</a>
              </td>
            </tr>
          </tbody>
      <?php  } ?>
      ...
      <hr>
        ...
        <a href="tambah/tambah-misi.php" class="btn btn-primary">Tambah Misi</a>
      ...
      ?>
          <tbody class="text-center">
            <tr>
              ...
              <td><?= $result['misi'] ?></td>
              <td>
                <a href="edit/edit-misi.php?id=<?= $result['id_misi']; ?>" class="btn btn-success">Edit</a>
              </td>
              <td>
                <a href="hapus/hapus-misi.php?id=<?= $result['id_misi']; ?>" class="btn btn-danger">Hapus</a>
              </td>
            </tr>
          </tbody>
      <?php  } ?>
