...
<html lang="en">
  ...
  <body>
    ...
    <div class="row no-gutters mt-5">
      ...
      <h3><i class="fas fa-bullhorn mr-2"></i>Pengumuman</h3>
      <hr>
      
      <a href="tambah/tambah-pengumuman.php" class="btn btn-primary"><i class="fas fa-plus mr-2"></i>Tambah Pengumuman</a>
      ...
      ?>
          <tbody class="text-center">
            <tr>
              ...
              <td>
                <a href="edit/edit-pengumuman.php?id=<?= $result['id_pengumuman']; ?>" class="btn btn-success">Edit</a>
              </td>
              <td>
                <a href="hapus/hapus-pengumuman.php?id=<?= $result['id_pengumuman']; ?>" class="btn btn-danger">Hapus</a>
              </td>
            </tr>
          </tbody>
      <?php  } ?>
