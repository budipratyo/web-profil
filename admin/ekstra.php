...
<html lang="en">
  ...
  <body>
    ...
    <div class="row no-gutters mt-5">
      ...
      <h3><i class="fas fa-user-edit mr-2">  </i>EKSTRAKULIKULER</h3>
      <hr>
      
      <a href="tambah/tambah-ekstra.php" class="btn btn-primary"><i class="fas fa-plus mr-2"></i>Tambah Ekstrakulikuler</a>
      ...
      ?>
          <tbody class="text-center">
            <tr>
              ...
              <td>
                <a href="edit/edit-ekstra.php?id=<?= $result['id_ekstra']; ?>" class="btn btn-success">Edit</a>
              </td>
              <td>
                <a href="hapus/hapus-ekstra.php?id=<?= $result['id_ekstra']; ?>" class="btn btn-danger">Hapus</a>
              </td>
            </tr>
          </tbody>
      <?php  } ?>
