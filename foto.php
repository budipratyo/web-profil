    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-12 col-md-8">
          <div class="konten">
            <div class="row">
            <h3>Foto SMA Muhammadiyah 4 Kendal
              <div class="progress">
                  <div class="progress-bar bg-warning" role="progressbar" style="width: 30%" aria-valuenow="35" aria-valuemin="0" aria-valuemax="100"></div>
             ...
             <?php
                  ...
                  $query = mysqli_query($koneksi, "SELECT * FROM galeri ORDER BY id_galeri DESC LIMIT $start, $perPage");
                    while ($result = mysqli_fetch_assoc($query)) {

              ?>
            <div class="col-sm-12 col-md-6">
                <div class="card">
                    <img src="asset/img/galeri/<?= $result['foto'] ?>" height="300">
                  <div class="card-body">
