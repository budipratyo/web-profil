            ...
            <div class="row">
              ...
              <div class="card col-sm-11" >
                  <?php if ($result['foto'] !== "nogambar"): ?>
                      ...
                      <img style="display: block;margin: auto; margin-top: 30px;" src="asset/img/ipm/<?= $result['foto'] ?>" width='700' height="370">
                  <?php endif ?>
                  <div class="card-body">
                    <h5 class="card-title"><?= $result['judul'] ?></h5>
                    <p class="card-title" style="text-indent: 8%;"><?= $result['deskripsi'] ?></p>
                  </div>
              </div>
            </div>
          </div>
