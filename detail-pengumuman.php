        ...
        <div class="col-sm-12 col-md-8">
          <div class="konten">
            <div class="row">
                ...
                ?>
              <div class="card col-sm-11 mt-5">
                  <div class="card-body">
                    <h3 class="card-title"><?= $result['judul_pengumuman'] ?></h3>
                    <p class="card-title" style="margin-top: -10px; margin-bottom: 20px;"><?= $result['tanggal']; ?></p>
